...
In polar coordinates, the base vector $\rhat$ points in the direction of positive change of $r$, that being outwards from the center. Consequently, for the angles $\theta\in(0\,,\pi)$, $\nhat=-\thetahat$ and when $\theta\in(\pi\,,2\pi)$, $\nhat=\thetahat$\,. Therefore, at the boundary of the cylinder when $r=R$,
$$\begin{matrix}
