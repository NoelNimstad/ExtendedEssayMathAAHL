...
This finds the greatest change the equation of greatest change for $f$ in the direction differentiated by, so if we combine the partial derivatives in all directions $f$ takes as parameters into a vector, then we end up with a vector pointing in the direction of steepest ascent.
