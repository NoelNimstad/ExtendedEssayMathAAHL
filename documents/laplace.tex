...
\subsection{The equation of the velocity potential}\label{section:THE-FORMULAE}
...
% \subsection{Summary}
% In summary, by finding general solutions to Laplace's equation and then applying constraints in the form of the boundary equations, it has been showed that the velocity field and potential are expressed as
% \begin{align*}
...
%     \end{matrix}\right.
% \end{align*}
% in a polar coordinate system and as
% \begin{align*}
