...
\begin{defn}
	In the case of fluid dynamics, \definedterm{divergence} can be thought as the operator which calculates the rate of change
	of \emph{fluid} at a certain point, if more is coming in rather than flowing out.
\end{defn}