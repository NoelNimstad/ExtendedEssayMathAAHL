...
\begin{lemma}[The Jacobian chain rule]
    ...
    \begin{proof}
        ...
        $$
        As $\delta_\vec{t}\rightarrow\vec{0}$, the error terms $\epsilon_\fatf$ and $\epsilon_\vec{G}$ by definition also approach $\vec{0}$, thus
        \begin{align}
            ...
            \notag&=\lim_{\delta_t\rightarrow0}\jacobian_\fatf(\vec{u})\jacobian_\vec{G}(\vec{t})\hat{\delta_\vec{t}}\\
