...
\begin{lemma}[The Jacobian chain rule]\label{lemma:JACOBIAN-CHAIN}
    ...
    \begin{proof}
        ...
        \end{align*}
        Since this equality holds for non-zero vectors $\hat{\delta_\vec{t}}$, the matrix mapping the unit vector $\hat{\delta_\vec{t}}$ must be the zero matrix, consequently,
        \begin{align*}
            \vec{A}-\vec{B}&=\vec{0}\\
            \implies\vec{A}&=\vec{B}\\
