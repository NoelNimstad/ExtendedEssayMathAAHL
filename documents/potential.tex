...
it is helpful to define the problem in polar coordinates. For unique polar coordinates, consider the restrictions $r\in(0,\infty)$ and $\theta\in[0,2\pi)$.

\subsection{Polar form of the gradient}
...
\begin{lemma}
    ...
    \begin{proof}
        ...
        $$
            ...
            \end{bmatrix}
        $$
        To, invert the matrix, use the formula
        \begin{align*}
